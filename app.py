...
try:
    ...
    # Fallback for template - user should create config.py
...
# --- Helper function to get league name from FPL API ---
...
# Add your logo URL here or remove this section
# LOGO_URL = "https://your-domain.com/your-logo.svg"
# st.markdown(
#     f"""
...
# Dynamic league name will be set after data loading
league_name = "FPL Dashboard"  # Default fallback

try:
    # --- Get the actual league name from FPL API ---
    league_name = get_league_name()
    
    # --- Display the dynamic league name ---
    st.markdown(f"<h3 style='text-align: center;'>🏆 {league_name} 🏆</h3>", unsafe_allow_html=True)
